...
class GreenTriangle
{
    ...
    constructor()
    {
        ...
        // version WEBGL1 au cas où le navigateur ne soit pas capable

        let srcVertexShaderV1 = dedent
            `#version 100
        ...
        let srcFragmentShaderV1 = dedent
            `#version 100
            precision mediump float;
            void main()
            {
                gl_FragColor = vec4(0.40, 0.75, 0.11, 1.0);
            }`;
        ...
        try {
            ...
            this.m_ShaderId = Utils.makeShaderProgram(srcVertexShaderV1, srcFragmentShaderV1, "Triangle");
            document.getElementById("debug").innerHTML =  "Votre navigateur ne peut pas faire du WebGL2";
            console.debug("Source du vertex shader :\n"+srcVertexShaderV1);
            console.debug("Source du fragment shader :\n"+srcFragmentShaderV1);
        }
