...
class Cube
{
    ...
    constructor()
    {
        ...
        this.m_ShaderId = Utils.makeShaderProgram(srcVertexShaderV2, srcFragmentShaderV2, "Cube");
        ...
        let colors = [
            ...
            0.0, 0.5, 1.0,  // P4 bleu
            1.0, 0.5, 0.0,  // P5 orange
            0.0, 1.0, 0.0,  // P6 vert
            0.7, 0.0, 0.7,  // P7 violet
        ];
    ...
    onDraw(matP, matV)
    {
        ...
        mat4.translate(this.m_MatVM, matV, vec3.fromValues(0, 0, 3.0*Math.sin(100*0.5)));
